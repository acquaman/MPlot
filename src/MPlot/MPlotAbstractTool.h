...
public:
	...
	MPlotAbstractTool(const QString &name, const QString &description = QString(), const QRectF& geometry = QRectF(0,0,100,100));
	...
	void setDescription(const QString &newDescription) { description_ = newDescription; }
