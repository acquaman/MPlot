...
void MPlotMarkerTransparentVerticalRectangle::setHighlighted(bool highlight)
{
	if (highlight)
...
QRectF MPlotMarkerTransparentVerticalRectangle::dataRect() const
{
	return QRectF(low_, 0, high_-low_, 0.95);
}

void MPlotMarkerTransparentVerticalRectangle::paint(QPainter *painter, const QStyleOptionGraphicsItem *option, QWidget *widget)
{
	Q_UNUSED(option);
	Q_UNUSED(widget);
